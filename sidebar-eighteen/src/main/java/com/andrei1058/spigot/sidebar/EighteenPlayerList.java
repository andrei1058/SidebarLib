...
class EighteenPlayerList extends ScoreboardTeam implements VersionedTabGroup {
    ...
    public EighteenPlayerList(@NotNull WrappedSidebar sidebar, String identifier, SidebarLine prefix, SidebarLine suffix,
