...
public class SeventeenPlayerList extends ScoreboardTeam implements VersionedTabGroup {
    ...
    public SeventeenPlayerList(@NotNull WrappedSidebar sidebar, String identifier, SidebarLine prefix, SidebarLine suffix,
