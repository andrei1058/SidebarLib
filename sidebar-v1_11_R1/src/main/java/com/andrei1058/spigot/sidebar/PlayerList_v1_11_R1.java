...
public class PlayerList_v1_11_R1 extends ScoreboardTeam implements PlayerList {
    ...
    private final Sidebar_v1_11_R1 sidebar;
    ...
    public PlayerList_v1_11_R1(@NotNull Sidebar_v1_11_R1 sidebar, @NotNull Player player, SidebarLine prefix, SidebarLine suffix, boolean disablePushing) {
    ...
    public void addPlayer(String name) {
        ...
        CustomScore_v1_11_R1.sendScore(sidebar, name, 20);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayerList_v1_11_R1)) return false;
        PlayerList_v1_11_R1 that = (PlayerList_v1_11_R1) o;
