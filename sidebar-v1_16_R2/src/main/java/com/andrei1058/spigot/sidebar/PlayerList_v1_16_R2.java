...
public class PlayerList_v1_16_R2 extends ScoreboardTeam implements PlayerList {

    private final boolean disablePushing;
    private SidebarLine prefix, suffix;
    private final Sidebar_v1_16_R2 sidebar;
    ...
    public PlayerList_v1_16_R2(@NotNull Sidebar_v1_16_R2 sidebar, @NotNull Player player, SidebarLine prefix, SidebarLine suffix, boolean disablePushing) {
    ...
    public void addPlayer(String name) {
        ...
        CustomScore_v1_16_R2.sendScore(sidebar, name, 20);
