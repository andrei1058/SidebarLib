...
public class Sidebar_v1_16_R3 implements com.andrei1058.spigot.sidebar.Sidebar {
    ...
    private final ConcurrentHashMap<String, PlayerList_v1_16_R3> teamLists = new ConcurrentHashMap<>();

    private final SidebarObjective sidebarObjective;

    public Sidebar_v1_16_R3(@NotNull SidebarLine title, @NotNull Collection<SidebarLine> lines, Collection<PlaceholderProvider> placeholderProvider) {
    ...
    public void addPlaceholder(PlaceholderProvider placeholderProvider) {
        ...
        for (Sidebar_v1_16_R3.ScoreLine line : lines) {
    ...
    public void playerListCreate(Player player, SidebarLine prefix, SidebarLine suffix, boolean disableCollisions) {
        ...
        PlayerList_v1_16_R3 team = new PlayerList_v1_16_R3(this, player, prefix, suffix, disableCollisions);
    ...
    public void playerListAddPlaceholders(Player player, PlaceholderProvider[] placeholderProviders) {
        PlayerList_v1_16_R3 list = teamLists.getOrDefault(player.getName(), null);
        if (list == null) return;
    ...
    public void playerListRemove(String teamName) {
        PlayerList_v1_16_R3 list = teamLists.getOrDefault(teamName, null);
        if (list != null) {
    ...
    public void playerListHideNameTag(@NotNull Player player) {
        PlayerList_v1_16_R3 listed = teamLists.get(player.getName());
        if (listed != null) {
            listed.hideNameTag();
        }
    }
    ...
    public void refreshHealth(Player player, int health) {
        ...
        CustomScore_v1_16_R3.sendScore(this, player.getName(), health);
    }
    ...
    private static void scoreOffsetIncrease(@NotNull Collection<ScoreLine> lineCollections) {
        for (Sidebar_v1_16_R3.ScoreLine line : lineCollections) {
