...
public class PlayerList_v1_16_R3 extends ScoreboardTeam implements PlayerList {

    private final boolean disablePushing;
    private SidebarLine prefix, suffix;
    private final Sidebar_v1_16_R3 sidebar;
    ...
    public PlayerList_v1_16_R3(@NotNull Sidebar_v1_16_R3 sidebar, @NotNull Player player, SidebarLine prefix, SidebarLine suffix, boolean disablePushing) {
    ...
    public void addPlayer(String name) {
        ...
        CustomScore_v1_16_R3.sendScore(sidebar, name, 20);
