...
public class PlayerList_v1_16_R1 extends ScoreboardTeam implements PlayerList {
    ...
    private final Sidebar_v1_16_R1 sidebar;
    ...
    public PlayerList_v1_16_R1(@NotNull Sidebar_v1_16_R1 sidebar, @NotNull Player player, SidebarLine prefix, SidebarLine suffix, boolean disablePushing) {
    ...
    public IChatBaseComponent getPrefix() {
        ...
        t = SidebarManager.getPapiSupport().replacePlaceholders(getPlayer(), t);
    ...
    public void addPlayer(String name) {
        ...
        CustomScore_v1_16_R1.sendScore(sidebar, name, 20);
