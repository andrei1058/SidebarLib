...
class Sidebar_v1_9_R2 implements com.andrei1058.spigot.sidebar.Sidebar {
    ...
    private ConcurrentHashMap<String, PlayerList_v1_9_R2> teamLists = new ConcurrentHashMap<>();
    ...
    public void playerListHideNameTag(@NotNull Player player) {
        PlayerList_v1_9_R2 listed = teamLists.get(player.getName());
        if (listed != null){
            listed.hideNameTag();
        }
    }
    ...
    public void playerListAddPlaceholders(@NotNull Player player, PlaceholderProvider... placeholderProviders) {
        PlayerList_v1_9_R2 list = teamLists.getOrDefault(player.getName(), null);
        if (list == null) return;
    ...
    public void playerListRemove(String teamName) {
        PlayerList_v1_9_R2 list = teamLists.getOrDefault(teamName, null);
        if (list != null) {
