...
public class PlayerList_v1_9_R2 extends ScoreboardTeam implements PlayerList {
    ...
    private final Sidebar_v1_9_R2 sidebar;
    ...
    public PlayerList_v1_9_R2(@NotNull Sidebar_v1_9_R2 sidebar, @NotNull Player player, SidebarLine prefix, SidebarLine suffix, boolean disablePushing) {
    ...
    public void addPlayer(String name) {
        ...
        CustomScore_v1_9_R2.sendScore(sidebar, name, 20);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayerList_v1_9_R2)) return false;
        PlayerList_v1_9_R2 that = (PlayerList_v1_9_R2) o;
