...
class NineteenPlayerList extends ScoreboardTeam implements VersionedTabGroup {
    ...
    public NineteenPlayerList(@NotNull WrappedSidebar sidebar, String identifier, SidebarLine prefix, SidebarLine suffix,
